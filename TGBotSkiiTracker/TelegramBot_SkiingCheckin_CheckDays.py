...
async def admin_commands(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    admin_commands_text = (
        ...
        f"/toggleAnnounce - Toggle Active Riders (Currently: {announce_status})\n\n"
        "**Content Management:**\n"
...
async def toggle_announce_auth_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if answer == '13':
        ...
        await query.edit_message_text(
            ...
            f"{'The scheduler will post updates at scheduled times.' if new_status else 'The scheduler is paused - no announcements will be posted.'}"
        )
...
async def message_of_the_day(context: ContextTypes.DEFAULT_TYPE):
    ...
    message = (
        ...
        f"💫 {motd_text}\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"🏔️ Make sure you /addProfile to register your name to the bot (me)! Only have to do this once\n"
...
async def daily_weather_update(context: ContextTypes.DEFAULT_TYPE):
    """Fetch weather and post to group at 4am MT"""
    weather_data = {}
    all_mountains = EPM_MOUNTAINS + IPM_MOUNTAINS + LOVELAND_MOUNTAINS
